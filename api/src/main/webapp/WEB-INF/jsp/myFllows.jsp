...
<div style="width:80%;height: 80%;margin-left:5%;margin-top: 30px;">
    <h1 align="center">
        我的关注列表
    </h1>
    <div id="follow-list" style="margin-left:10%;margin-top:50px;width: 80%;height: 80%;border: #cccccc solid;"></div>
</div>
...
<script>
    ...
    function getFollowList() {
        ...
        $.ajax({
            ...
            url: "follower/follows?token=" + token.token.token,
            dataType: "json",
            success: function (result) {
                ...
                if (result.data.length == 0) {
                    ...
                    content.innerHTML = '您尚未关注任何用户';
                    document.getElementById("follow-list").appendChild(content);
                }
                for (var i = 0; i < result.data.length; i++) {
                    ...
                    content.innerHTML = '<a href="#" style="text-decoration: none" onclick="turnUserPage()">' + result.data[i].userName + '</a><br><br>'
                     + '<span>文章</span><span style="margin-left: 15px;">' + result.data[i].blogs + '</span><br><br>'
                     + '<span>粉丝</span><span style="margin-left: 15px;">' + result.data[i].fans + '</span>';
                    document.getElementById("follow-list").appendChild(content);
                }
            }
        })
