...
<div id="box" align="left" style="width: 45%;padding-top: 100px; float: left;padding-left: 5%;">
    ...
    <br><br>
    <a id="blogs" href="myBlogs" style="text-decoration: none;color: #66afe9;width: 30%;padding-right: 40px;"></a>
    <a id="follows" href="myFllows" style="text-decoration: none;color: #66afe9;width: 30%;padding-right: 40px;"></a>
    <a id="fans" href="myFollowers" style="text-decoration: none;color: #66afe9;width: 30%;padding-right: 40px;"></a>
