...
<div id="box" style="width: 60%;padding-top: 50px;padding-left: 20%;">
    ...
    <div style="border:  #cccccc solid;">
        <textarea id="content" style="font-size: 20px;width: 100%;height:600px;"></textarea>
    </div>
</div>
<br><br>
<div id="submit" align="center" style="padding-right: 20px;">
    <button style="background-color: #66afe9;height: 40px;width: 80px;" onclick="createBlog()">发布</button>
    <button style="background-color: #66afe9;height: 40px;width: 80px;" onclick="back()">返回</button>
</div>
...
<script>
    ...
    function createBlog(){
        ...
        $.ajax({
            type: "POST",
            url: "blog" + "?token=" + token.token.token,
            contentType:"application/json",
            data:JSON.stringify(data),
            success: function(result){
                Cookies.set("blogId",result.data);
